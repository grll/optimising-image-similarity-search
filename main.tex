...
ADD VISUAL CONFIRMATION (IMG) to confirm the result...
	...
	\begin{table}[h]
		...
		\begin{tabular}{ c | c | c | c | c | c |}
			\cline{2-6}
			& \multirow{2}{*}{dataset} & \multicolumn{4}{ |c|  }{search\_k} \\ \cline{3-6}
			& & 2 & 8 & 32 & 64 \\ \cline{1-6}
			\multicolumn{1}{|c|}{\multirow{2}{*}{k=2}} & RAW & 54.2 s & 55 s & 50s & 76s \\ \cline{2-6}
			\multicolumn{1}{|c|}{} & PCA & 34s & 45s & 50s & 76s \\ \cline{1-6}
			\multicolumn{1}{|c|}{\multirow{2}{*}{k=6}} & RAW & 34s & 45s & 50s & 76s \\ \cline{2-6}
			\multicolumn{1}{|c|}{} & PCA & 34s & 45s & 50s & 76s \\ \cline{1-6}
		\end{tabular}
